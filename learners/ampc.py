...
class AMPCLearner(object):
    ...
    def model_rollout_for_update(self, start_obses, ite, mb_ref_index):
        ...
        veh2line4real_sum = self.tf.zeros((start_obses.shape[0],))
        obses = start_obses
        ...
        for _ in range(self.num_rollout_list_for_policy_update[0]):
            ...
            obses, rewards, punish_terms_for_training, real_punish_term, veh2veh4real, veh2road4real, veh2line4real = self.model.rollout_out(actions)
